...
**Purpose:**
Verify that phase plans fully cover the requirements before execution.
Catches gaps early, before any code is written.
</context>

<objective>
Validate phase N plans against requirements.

**Output:**
- Validation report showing coverage
- List of any uncovered requirements
- Recommendations for additional plans if needed
...
.planning/{N}-*-PLAN.md (all plans for phase N)
