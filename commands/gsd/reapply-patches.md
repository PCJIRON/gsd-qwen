...
Reapply patches (code changes) that were lost during merge conflicts, failed rebases, accidental reverts, or branch resets.
...
3. **Load `.planning/STATE.md`** for context:
...
8. **Create recovery report** and save to `.planning/PATCH-RECOVERY.md`:
...
9. Create commit: `[GSD] Reapply lost patches`
